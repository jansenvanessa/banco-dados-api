...
/*
mongoose.connect("mongodb://alunareprograma:reprograma12@cluster0-shard-00-00.kuokc.mongodb.net:27017,cluster0-shard-00-01.kuokc.mongodb.net:27017,cluster0-shard-00-02.kuokc.mongodb.net:27017/reprograma-trip?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority", { // no nosso caso nao temos usuario e senha, mas caso tivessemos poderiamos seguir esse formato: mongodb://username:password@localhost:27017/reprograma-trip
    useNewUrlParser: true, // define que vai utilizar a nova url parse da string de conexao
    useUnifiedTopology: true // define que vai utilizar o novo mecanismo de gerenciamento de conexao do driver do mongodb
});
*/
